...
| `endpoint` | `string` | `https://app.opslane.com` | Your Opslane instance: an http(s) URL, or a same-origin path such as `/opslane` for a reverse proxy. Paths require a browser origin and always stay on that origin. |
