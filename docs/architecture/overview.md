...
| **Worker** (`packages/worker`) | Node service | Claims jobs from Postgres, investigates with Claude, classifies routes, writes candidate fixes, verifies them in an E2B sandbox, and opens GitHub PRs. |
