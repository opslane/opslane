...
| --- | --- | --- |
| Anthropic API | Error details, stack traces, route patterns, relevant source file contents, test output | Only during investigation and route classification, only with `ANTHROPIC_API_KEY` set |
