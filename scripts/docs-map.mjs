...
export const MANUAL_DOC_COVERS = Object.freeze({
  ...
  'docs/contracts/notifications.md': Object.freeze([
    ...
    'packages/ingestion/db/migrations/*delivery_policy*.sql',
    'packages/ingestion/handler/notifications.go',
    'packages/ingestion/notify/event.go',
    'packages/ingestion/notify/slack.go',
    'packages/worker/src/db.ts',
    'test-fixtures/wire/issue-triaged-*.json',
  ]),
