...
func (q *Queries) AdminOverviewData(ctx context.Context) (*AdminOverview, error) {
	result := &AdminOverview{
		...
		Jobs: AdminJobOverview{
			...
			ByType: map[string]int64{"investigate": 0, "fix": 0, "error_fix": 0, "session_analysis": 0, "ci_watch": 0, "route_map": 0, "product_context": 0, "issue_inquiry": 0, "digest_write": 0, "score_sync": 0, "stack_resolve": 0, "friction_match": 0, "friction_confirm": 0, "friction_reconcile": 0, "friction_pr_event": 0},
		},
